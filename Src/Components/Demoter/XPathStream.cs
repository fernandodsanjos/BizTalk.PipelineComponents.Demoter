    ...
    public class XPathStream : Stream
    {
        ...
        protected virtual void TranslateAttribute()
        {
            ...
            while (this.m_reader.ReadAttributeValue())
            {
                ...
                {
                    this.TranslateAttributeValue(prefix, localName, namespaceUri, Demote(this.m_reader.Value,expr));
                }
                else
        ...
        protected virtual void TranslateElement()
        {
            ...
            {
                bool hasvalue = this.m_reader.HasValue;
                this.m_reader.Read();//read to text

                this.m_writer.WriteString(Demote(this.m_reader.Value, expr));
