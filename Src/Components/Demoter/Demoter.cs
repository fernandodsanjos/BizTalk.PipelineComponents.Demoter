...
namespace BizTalk.PipelineComponents
{
    ...
    public class Demoter : IBaseComponent, IComponent, IComponentUI, Microsoft.BizTalk.Component.Interop.IPersistPropertyBag
    {
